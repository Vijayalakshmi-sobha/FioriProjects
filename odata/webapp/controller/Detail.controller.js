sap.ui.define([
    ...
    "use strict";
        let oSearch ;
        let oSelectedField ;
    return Controller.extend("com.applexus.odata.controller.Detail", {
        onInit() {


            this.oRouter = this.getOwnerComponent().getRouter();
            this.oRouter.getRoute("RouteDetail").attachPatternMatched(this.onDetails,this);
        ...
        onCity:function(oEvt){
            ...
            this.loadFragment({
                    name: "com.applexus.odata.fragments.popup",
                    controller: this
